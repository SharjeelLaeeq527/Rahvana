    ...
    stages: [
        {
            ...
            descriptionUr: "امریکی پٹیشنر I-130 فائل کرتا ہے → USCIS پراسیس کرتا ہے → منظوری",
            ...
            steps: [
                {
                    ...
                    actionsUr: ["تصدیق کریں کہ پٹیشنر امریکی شہری ہے", "تصدیق کریں کہ قانونی شادی وجود رکھتی ہے", "تصدیق کریں کہ شادی حقیقی (بونا فائیڈ) ہے", "رہائشی ضروریات کو چیک کریں", "امیگریشن میں کسی رکاوٹ کی عدم موجودگی کی تصدیق کریں"],
                    ...
                    notesUr: "پٹیشنر کا امریکی شہری ہونا ضروری ہے (گرین کارڈ ہولڈر نہیں)۔ شادی قانونی اور حقیقی ہونی چاہیے۔"
                },
                {
                    id: "I-02",
                    ...
                    actionsUr: ["امریکی شہریت کا ثبوت جمع کریں", "پاکستانی پاسپورٹ حاصل کریں", "نادرا برتھ سرٹیفکیٹ حاصل کریں", "نکاح نامہ + ترجمہ حاصل کریں", "یونین کونسل میرج رجسٹریشن حاصل کریں", "پولیس سرٹیفکیٹ کے لیے درخواست دیں", "پاسپورٹ سائز تصاویر لیں"],
                    ...
                    documentsUr: ["امریکی پاسپورٹ/برتھ سرٹیفکیٹ", "پاکستانی پاسپورٹ", "نادرا برتھ سرٹیفکیٹ", "نکاح نامہ (اصل)", "نکاح نامہ کا انگریزی ترجمہ", "یونین کونسل میرج رجسٹریشن", "پولیس سرٹیفکیٹ", "پاسپورٹ سائز تصاویر (2x2 انچ)"],
                ...
                },
                {
                    ...
                    actionsUr: ["آن لائن ($625) بمقابلہ کاغذی ($675) کا موازنہ کریں", "پروسیسنگ کی رفتار پر غور کریں", "فائلنگ کا طریقہ منتخب کریں"],
                    fee: "Online: $625, Paper: $675",
                    notes: "Online filing recommended - faster receipt, lower fee, electronic tracking",
                    notesUr: "آن لائن فائلنگ کی سفارش کی جاتی ہے - تیزی سے وصولی، کم فیس، الیکٹرانک ٹریکنگ"
                },
                {
                    id: "I-04",
                    ...
                    actionsUr: ["USCIS اکاؤنٹ بنائیں (اگر آن لائن ہو)", "حصہ 1: تعلق مکمل کریں", "حصہ 2: پٹیشنر کی معلومات مکمل کریں", "حصہ 3: فائدہ اٹھانے والے (beneficiary) کی معلومات مکمل کریں", "حصہ 4-10 مکمل کریں", "تمام معلومات کا جائزہ لیں", "معاون دستاویزات اپ لوڈ کریں"],
                ...
                },
                {
                    ...
                    actionsUr: ["فائدہ اٹھانے والے کی بائیو گرافک معلومات فراہم کریں", "والدین کی معلومات شامل کریں", "جسمانی خصوصیات فراہم کریں", "فارم سائن کریں"],
                    notes: "Always required for spouse petitions, no separate fee",
                    notesUr: "شریک حیات کی درخواستوں کے لیے ہمیشہ ضروری ہے، کوئی الگ فیس نہیں"
                },
                {
                    id: "I-06",
                    name: "Pay Filing Fee",
                    ...
                    actionsUr: ["ادائیگی کا طریقہ منتخب کریں", "ادائیگی کی معلومات درج کریں", "ادائیگی جمع کرائیں", "تصدیق نامہ محفوظ کریں"],
                    notes: "As of Oct 28, 2025: Checks/money orders NO LONGER accepted. Electronic payment only.",
                    notesUr: "28 اکتوبر 2025 تک: چیک/منی آرڈر اب قبول نہیں کیے جاتے۔ صرف الیکٹرانک ادائیگی۔",
                ...
                },
                {
                    ...
                    actionsUr: ["پوری درخواست کا جائزہ لیں", "اپ لوڈ کردہ دستاویزات کی تصدیق کریں", "سبمٹ پر کلک کریں (آن لائن) یا پیکج میل کریں", "تصدیق/رسید محفوظ کریں"],
                ...
                },
                {
                    ...
                    actionsUr: ["رسید نوٹس کے لیے میل/اکاؤنٹ چیک کریں", "تصدیق کریں کہ تمام معلومات درست ہیں", "رسید نمبر محفوظ کریں", "ترجیحی تاریخ (priority date) نوٹ کریں"],
                ...
                },
                {
                    ...
                    actionsUr: ["ہفتہ وار کیس اسٹیٹس چیک کریں", "کسی بھی RFE کا فوری جواب دیں", "ایڈریس اپ ڈیٹ رکھیں", "اس دوران NVC دستاویزات جمع کریں"],
                    notes: "RFE deadline usually 30-87 days. Respond promptly to avoid delays.",
                    notesUr: "RFE کی آخری تاریخ عام طور پر 30-87 دن ہوتی ہے۔ تاخیر سے بچنے کے لیے فوری جواب دیں۔"
                },
                {
                    id: "I-10",
                    ...
                    actionsUr: ["منظوری کا نوٹس موصول کریں", "متعدد کاپیاں بنائیں", "NVC رابطے کا انتظار کریں (4-6 ہفتے)", "دوسرے مرحلے کی تیاری شروع کریں"],
        ...
        },
        {
            ...
            descriptionUr: "فیسوں کی ادائیگی → DS-260 جمع کرانا → دستاویزات اپ لوڈ کرنا → دستاویزی طور پر اہل (DQ)",
            timeline: "4-9 months",
            steps: [
                {
                    id: "II-01",
                    ...
                    actionsUr: ["ای میل چیک کریں (بشمول اسپیم)", "کیس نمبر (ISL...) نوٹ کریں", "انوائس آئی ڈی نمبر نوٹ کریں", "دونوں نمبروں کو محفوظ طریقے سے محفوظ کریں"],
                ...
                },
                {
                    ...
                    actionsUr: ["CEAC پورٹل پر جائیں", "اکاؤنٹ بنائیں", "انوائس آئی ڈی درج کریں", "SSN اور تاریخ پیدائش درج کریں", "اکاؤنٹ میں کیس شامل کریں"],
                ...
                },
                {
                    ...
                    actionsUr: ["CEAC میں لاگ ان کریں", "کفالت کے حلف نامے کی فیس ($120) ادا کریں", "امیگرنٹ ویزا فیس ($345) ادا کریں", "ادائیگی کی تصدیقات محفوظ کریں"],
                    ...
                    notesUr: "فیس ناقابل واپسی ہے۔ ادائیگی 1-2 کاروباری دنوں میں ظاہر ہوتی ہے۔"
                },
                {
                    id: "II-04",
                    ...
                    actionsUr: ["CEAC میں DS-260 تک رسائی حاصل کریں", "تمام 24 حصے مکمل کریں", "سیکیورٹی سوالات کے سچائی سے جواب دیں", "پوری درخواست کا جائزہ لیں", "الیکٹرانک طور پر سائن کریں اور جمع کریں"],
                    ...
                    notesUr: "جمع کرانے کے بعد تبدیل نہیں کیا جا سکتا سوائے NVC ای میل کے۔ کثرت سے سیو کریں!",
                ...
                },
                {
                    ...
                    documentsUr: ["برتھ سرٹیفکیٹ (نادرا)", "نکاح نامہ (اصل + ترجمہ + یونین کونسل)", "پولیس سرٹیفکیٹ (اصل)", "پاسپورٹ بائیو گرافیکل پیج", "سابقہ شادی کا خاتمہ (اگر لاگو ہو)"],
                    actions: ["Scan all documents (300 DPI, PDF)", "Ensure translations certified", "Verify all stamps/seals visible", "Name files clearly"],
                    actionsUr: ["تمام دستاویزات کو اسکین کریں (300 DPI، پی ڈی ایف)", "یقینی بنائیں کہ ترجمہ تصدیق شدہ ہے", "تصدیق کریں کہ تمام مہریں/مہریں نظر آ رہی ہیں", "فائلوں کے نام واضح رکھیں"],
                ...
                },
                {
                    ...
                    actionsUr: ["I-864 فارم ڈاؤن لوڈ کریں", "تمام حصے مکمل کریں", "IRS ٹیکس ٹرانسکرپٹ (3 سال) جمع کریں", "ملازمت کا خط حاصل کریں", "تنخواہ کی سلپس (6 ماہ) جمع کریں", "فارم سائن کریں"],
                    ...
                    notesUr: "کم از کم آمدنی: 2 افراد کے گھرانے کے لیے $25,550 (2025)۔ اگر ضرورت ہو تو جوائنٹ اسپانسر استعمال کریں۔",
                ...
                },
                {
                    ...
                    actionsUr: ["CEAC میں لاگ ان کریں", "دستاویزات (Documents) کے سیکشن پر جائیں", "ہر دستاویز کی کیٹیگری اپ لوڈ کریں", "اپ لوڈ کی کامیابی کی تصدیق کریں", "گرین چیک مارکس چیک کریں"],
                    ...
                    notesUr: "ایک ایک کر کے اپ لوڈ کریں۔ فی فائل زیادہ سے زیادہ 4 ایم بی۔ پی ڈی ایف کو ترجیح دی جاتی ہے۔"
                },
                {
                    id: "II-08",
                    ...
                    actionsUr: ["تمام اپ لوڈ کردہ دستاویزات کا جائزہ لیں", "تصدیق کریں کہ ترجمہ شامل ہے", "مالی دستاویزات کی کفایت چیک کریں", "Submit Documents پر کلک کریں", "تصدیق نامہ محفوظ کریں"],
                ...
                },
                {
                    ...
                    actionsUr: ["ہفتہ وار CEAC اسٹیٹس کی نگرانی کریں", "اپ ڈیٹس کے لیے ای میل چیک کریں", "کسی بھی دستاویز کی درخواست کا فوری جواب دیں"],
                    ...
                    notesUr: "عام مسترد ہونے کی وجوہات: خراب اسکین کوالٹی، ترجمہ کا غائب ہونا، میعاد ختم ہونے والا پولیس سرٹیفکیٹ"
                },
                {
                    id: "II-10",
                    ...
                    actionsUr: ["DQ تصدیقی ای میل موصول کریں", "تصدیق کریں کہ CEAC DQ اسٹیٹس دکھا رہا ہے", "DQ کی تاریخ نوٹ کریں", "انٹرویو کی تیاری شروع کریں"],
                ...
                },
                {
                    ...
                    actionsUr: ["ہفتہ وار CEAC چیک کریں", "یقینی بنائیں کہ پاسپورٹ کارآمد ہے", "ابھی نیا پولیس سرٹیفکیٹ حاصل نہ کریں", "انٹرویو کے عمل پر تحقیق کریں"],
                    notes: "Cannot speed up this process. Interview scheduled by embassy.",
                    notesUr: "اس عمل کو تیز نہیں کیا جا سکتا۔ انٹرویو سفارت خانے کے ذریعے طے کیا جاتا ہے۔"
                },
                {
                    id: "II-12",
                    ...
                    actionsUr: ["انٹرویو کی ملاقات موصول کریں", "تاریخ اور وقت نوٹ کریں", "میڈیکل امتحان فوری طور پر شیڈول کریں", "اصل دستاویزات جمع کریں", "اگر ضرورت ہو تو سفر کے انتظامات کریں"],
        ...
        },
        {
            ...
            descriptionUr: "میڈیکل امتحان مکمل کریں → قونصلر انٹرویو میں شرکت کریں → ویزا کا فیصلہ",
            ...
            steps: [
                {
                    ...
                    actionsUr: ["IOM کلینک سے رابطہ کریں", "انٹرویو سے 1-5 دن پہلے ملاقات بک کریں", "درکار دستاویزات نوٹ کریں", "تصدیق نامہ محفوظ کریں"],
                    ...
                    notesUr: "میڈیکل کے نتائج 6 ماہ تک کارآمد ہیں۔ مثالی طور پر انٹرویو سے 2-3 دن پہلے شیڈول بنائیں۔"
                },
                {
                    id: "III-02",
                    ...
                    actionsUr: ["پولیس خدمت مرکز یا آن لائن درخواست دیں", "شناختی کارڈ (CNIC)، پاسپورٹ، اور ضرورت پڑنے پر حلف نامہ فراہم کریں", "سرٹیفکیٹ حاصل کریں", "انٹرویو کے لیے اصل پاس رکھیں"],
                    notes: "Get new if previous one is 6+ months old. Need ORIGINAL for interview.",
                    notesUr: "اگر پچھلا سرٹیفکیٹ 6 ماہ سے زیادہ پرانا ہے تو نیا حاصل کریں۔ انٹرویو کے لیے اصل (ORIGINAL) کی ضرورت ہے۔",
                ...
                },
                {
                    ...
                    documentsUr: ["کارآمد پاسپورٹ", "شناختی کارڈ (CNIC)", "انٹرویو لیٹر", "DS-260 کنفرمیشن", "برتھ سرٹیفکیٹ (اصل)", "نکاح نامہ (اصل)", "ترجمہ (اصل)", "یونین کونسل سرٹیفکیٹ", "پولیس سرٹیفکیٹ (اصل)", "بند میڈیکل لفافہ", "تصاویر (2)", "I-864 پیکیج", "ٹیکس ٹرانسکرپٹ", "ملازمت کا لیٹر", "تنخواہ کی سلپس"],
                    actions: ["Collect all original documents", "Make 2 sets of copies", "Organize in folders", "Label clearly"],
                    actionsUr: ["تمام اصل دستاویزات جمع کریں", "کاپیاں کے 2 سیٹ بنائیں", "فولڈرز میں ترتیب دیں", "واضح طور پر لیبل لگائیں"],
                    notes: "Bring originals + copies. Organize petitioner and beneficiary documents separately.",
                    notesUr: "اصل + کاپیاں لائیں۔ پٹیشنر اور فائدہ اٹھانے والے کی دستاویزات کو الگ الگ ترتیب دیں۔"
                },
                {
                    id: "III-04",
                    ...
                    actionsUr: ["دستاویزات کے ساتھ وقت پر پہنچیں", "انٹیک فارم مکمل کریں", "فیس ادا کریں", "جسمانی معائنہ", "سینے کا ایکسرے", "خون کے ٹیسٹ", "ویکسینیشن کا جائزہ", "ڈاکٹر کا انٹرویو"],
                    ...
                    notesUr: "لفافہ نہ کھولیں۔ نتائج 2-5 دنوں میں تیار ہو جاتے ہیں۔ انٹرویو سے 1-2 دن پہلے حاصل کریں۔"
                },
                {
                    id: "III-05",
                    ...
                    actionsUr: ["DS-260 کے جوابات کا جائزہ لیں", "عام سوالات کی مشق کریں", "تعلق کی تفصیلات کا مطالعہ کریں", "دستاویزی چیک لسٹ چیک کریں", "لباس (پیشہ ورانہ) کی منصوبہ بندی کریں", "اگر ضرورت ہو تو اسلام آباد کے سفر کا انتظام کریں"],
                    notes: "Be truthful, consistent. Know spouse details well. Dress professionally - no jeans/t-shirts.",
                    notesUr: "سچے اور مستقل مزاج رہیں۔ شریک حیات کی تفصیلات اچھی طرح جانیں۔ پیشہ ورانہ لباس پہنیں - جینز / ٹی شرٹس نہیں۔"
                },
                {
                    id: "III-06",
                    ...
                    actionsUr: ["30+ منٹ پہلے پہنچیں", "سیکیورٹی سے گزریں (کوئی الیکٹرونکس نہیں)", "ونڈو پر دستاویزات جمع کرائیں", "فنگر پرنٹس لیے جائیں گے", "قونصلر افسر کی کال کا انتظار کریں", "حلف لیں", "سوالات کے ایمانداری سے جواب دیں", "فیصلہ حاصل کریں"],
                    ...
                    notesUr: "عام سوالات: آپ کیسے ملے؟ اپنی شادی کے بارے میں بتائیں۔ آپ کہاں رہیں گے؟"
                },
                {
                    id: "III-07",
                    ...
                    actionsUr: ["اگر AP میں رکھا گیا ہو تو ہفتہ وار CEAC چیک کریں", "باقاعدگی سے ای میل چیک کریں", "رابطہ کرنے پر فوری جواب دیں", "صبر کریں - عمل تیز کرنے کا کوئی طریقہ نہیں ہے"],
                    notes: "AP duration: 2 weeks to 12+ months (unpredictable). Common for security clearances.",
                    notesUr: "AP کا دورانیہ: 2 ہفتے سے 12+ ماہ (غیر متوقع)۔ سیکورٹی کلیئرنس کے لیے عام ہے۔"
                }
            ]
        },
        {
            ...
            descriptionUr: "ویزہ کے ساتھ پاسپورٹ وصول کرنا → USCIS فیس کی ادائیگی → امریکہ کا سفر",
            ...
            steps: [
                {
                    ...
                    actionsUr: ["کورئیر (TCS) کو ٹریک کریں", "پاسپورٹ وصول کریں", "ویزہ فوائل (foil) کی معلومات کی تصدیق کریں", "میعاد ختم ہونے کی تاریخ چیک کریں", "کاپیاں بنائیں", "تصدیق کریں: نام، تاریخ پیدائش، پاسپورٹ نمبر، ویزہ کیٹیگری (IR-1/CR-1)"],
                    ...
                    notesUr: "ویزا کی میعاد ختم ہونے سے پہلے امریکہ میں داخل ہونا ضروری ہے (عام طور پر میڈیکل سے 6 ماہ)"
                },
                {
                    id: "IV-02",
                    ...
                    actionsUr: ["USCIS امیگرنٹ فیس سائٹ پر اکاؤنٹ بنائیں", "ویزہ سے A-نمبر درج کریں", "امریکہ کا میلنگ ایڈریس درج کریں (انتہائی اہم)", "$220 فیس ادا کریں", "تصدیق نامہ محفوظ کریں"],
                    ...
                    notesUr: "سفر سے پہلے ادائیگی کی سفارش کی جاتی ہے۔ 90 دنوں کے اندر گرین کارڈ اس پتے پر بھیج دیا جائے گا۔"
                },
                {
                    id: "IV-03",
                    ...
                    actionsUr: ["ویزہ ختم ہونے سے پہلے فلائٹ بک کریں", "ہینڈ بیگ میں رکھیں: پاسپورٹ، بند لفافے، کنفرمیشنز", "بند لفافوں کو نہ کھولیں", "ممنوعہ اشیاء کی فہرست تیار کریں", "پٹیشنر کو فلائٹ کی تفصیلات بتائیں"],
                    notes: "Sealed immigration packet MUST stay sealed. Pack in carry-on, never checked luggage.",
                    notesUr: "بند امیگریشن پیکٹ کو بند ہی رہنا چاہیے۔ اسے ہینڈ بیگ میں رکھیں، کبھی بھی بڑے سامان (checked luggage) میں نہ رکھیں۔"
                },
                {
                    id: "IV-04",
                    ...
                    actionsUr: ["سمجھیں: داخلے پر آپ LPR (مستقل مقیم) بن جائیں گے", "IR-1 بمقابلہ CR-1 کا فرق جانیں", "حقوق اور ذمہ داریوں کو سمجھیں", "جان لیں کہ شہری بننے تک ووٹ نہیں دے سکتے"],
                    notes: "IR-1: 10-year green card. CR-1: 2-year conditional, must file I-751 to remove conditions.",
                    notesUr: "IR-1: 10 سالہ گرین کارڈ۔ CR-1: 2 سالہ مشروط، شرائط ختم کرنے کے لیے I-751 فائل کرنا ضروری ہے۔"
                }
            ]
        },
        {
            ...
            descriptionUr: "امریکہ میں داخلہ → CBP معائنہ → I-551 اسٹیمپ → گرین کارڈ کی ڈیلیوری",
            ...
            steps: [
                {
                    ...
                    actionsUr: ["پاسپورٹ کنٹرول کے نشانات پر عمل کریں", "غیر ملکی شہریوں (Foreign Nationals) کی لائن میں جائیں", "CBP افسر کے پاس جائیں", "بتائیں: بطور امیگرنٹ پہلی بار داخلہ", "پاسپورٹ اور بند پیکٹ پیش کریں", "سوالات کے جواب دیں", "فنگر پرنٹس لیے جائیں گے"],
                ...
                },
                {
                    ...
                    actionsUr: ["اگر ہدایت کی جائے تو سیکنڈری ایریا میں جائیں", "افسر کا انتظار کریں", "اضافی معلومات فراہم کریں", "صبر اور تعاون سے کام لیں"],
                    notes: "Common for immigrant visa holders. Don't worry - routine.",
                    notesUr: "امیگرنٹ ویزہ ہولڈرز کے لیے عام ہے۔ پریشان نہ ہوں - یہ ایک روٹین ہے۔"
                },
                {
                    id: "V-03",
                    ...
                    actionsUr: ["افسر پاسپورٹ پر I-551 اسٹیمپ لگاتا ہے", "پاسپورٹ واپس کر دیا جاتا ہے", "بند پیکٹ CBP اپنے پاس رکھ لیتا ہے"],
                    ...
                    notesUr: "یہ اسٹیمپ جسمانی کارڈ آنے تک مستقل رہائش اور کام کرنے کی اجازت کا ثبوت ہے۔"
                },
                {
                    id: "V-04",
                    name: "Clear Customs",
                    ...
                    actionsUr: ["اپنا سامان جمع کریں", "کسٹم فارم پُر کریں", "$800 سے زیادہ کی اشیاء یا ممنوعہ اشیاء ظاہر کریں", "کسٹم افسر کو پیش کریں", "ائیرپورٹ سے باہر نکلیں"],
                    notes: "Declare any food, plants, amounts over $10,000 cash",
                    notesUr: "کسی بھی کھانے پینے کی اشیاء، پودوں، یا $10,000 سے زیادہ نقد رقم ظاہر کریں۔"
                },
                {
                    id: "V-05",
                    ...
                    actionsUr: ["امریکی رہائش گاہ پر پہنچیں", "سوشل سیکیورٹی کارڈ (2-4 ہفتے) کا انتظار کریں", "اگر موصول نہ ہو تو SSA آفس میں درخواست دیں", "گرین کارڈ کے میلنگ ایڈریس کی تصدیق کریں", "اگر مرد ہیں اور عمر 18-25 سال ہے تو سلیکٹیو سروس (Selective Service) کے لیے رجسٹر کریں"],
                    notes: "SSN auto-issued if checked Yes on DS-260. Green card arrives within 90 days of entry or payment.",
                    notesUr: "اگر DS-260 پر 'Yes' چیک کیا تھا تو SSN خود بخود جاری ہو جائے گا۔ گرین کارڈ داخلے یا ادائیگی کے 90 دنوں کے اندر پہنچ جاتا ہے۔"
                },
                {
                    id: "V-06",
                    ...
                    actionsUr: ["USCIS امیگرنٹ فیس اکاؤنٹ کے ذریعے ٹریک کریں", "USPS کے ذریعے گرین کارڈ وصول کریں", "تصدیق کریں کہ تمام معلومات درست ہیں", "کارڈ کی پشت پر فوری طور پر سائن کریں"],
                    ...
                    notesUr: "اگر کارڈ پر غلطی ہو تو فوری طور پر I-90 فائل کریں۔ IR-1: 10 سال کے لیے کارآمد۔ CR-1: 2 سال کے لیے کارآمد۔"
                },
                {
                    id: "V-07",
                    ...
                    actionsUr: ["گرین کارڈ ہر وقت اپنے پاس رکھیں", "سالانہ امریکی ٹیکس فائل کریں", "10 دن کے اندر USCIS کے ساتھ ایڈریس اپ ڈیٹ کریں (AR-11)", "منصوبہ بندی کے بغیر 6 ماہ سے زیادہ امریکہ سے باہر نہ رہیں", "CR-1 کے لیے: 2 سالہ سالگرہ کے 90 دنوں کے اندر I-751 فائل کریں"],
                    notes: "CR-1 CRITICAL: Must file I-751 jointly with spouse to remove conditions. Failure = loss of status.",
                    notesUr: "CR-1 انتہائی اہم: شرائط ختم کرنے کے لیے شریک حیات کے ساتھ مل کر I-751 فائل کرنا ضروری ہے۔ ناکامی = اسٹیٹس کا نقصان۔"
                },
                {
                    id: "V-08",
                    ...
                    actionsUr: ["LPR کے طور پر 3 سال بعد، N-400 کے ذریعے شہریت کے لیے درخواست دے سکتے ہیں", "ضروریات: جسمانی موجودگی، اچھا اخلاقی کردار، انگریزی، سوک (civics) ٹیسٹ"],
                    notes: "Optional - can remain LPR indefinitely. Citizenship allows voting, more job options, cannot be deported.",
                    notesUr: "اختیاری - غیر معینہ مدت تک LPR رہ سکتے ہیں۔ شہریت ووٹ ڈالنے، ملازمت کے مزید اختیارات کی اجازت دیتی ہے، اور اسے ملک بدر نہیں کیا جا سکتا۔"
                }
            ]
        }
    ],
