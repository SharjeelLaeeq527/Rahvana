...
import { DocumentDefinition, DocumentCategory, VisaCategory } from "./types";

const FAMILY_VISAS: VisaCategory[] = [
  "IR-1",
  "CR-1",
  "IR-2",
  "CR-2",
...
const USA_STUDENT_VISAS: VisaCategory[] = ["F-1 Student Visa"];
const AUSTRALIA_STUDENT_VISAS: VisaCategory[] = [
  "Australia Student Visa (Subclass 500)",
];
const CHINA_STUDENT_VISAS: VisaCategory[] = ["China Student Visa (X1 & X2)"];

const ALL_STUDENT_VISAS: VisaCategory[] = [
  ...USA_STUDENT_VISAS,
  ...AUSTRALIA_STUDENT_VISAS,
  ...CHINA_STUDENT_VISAS,
];
const UNIVERSAL_VISAS: VisaCategory[] = [...FAMILY_VISAS, ...ALL_STUDENT_VISAS];
...
const CIVIL_DOCS: DocumentDefinition[] = [
    ...
    wizardSteps: [
      {
        ...
        description:
          "Visit NADRA office or apply online to get your original birth certificate (Form-B or computerized NICOP/CNIC with date of birth).",
        resources: [
          {
      ...
      },
      {
        ...
        description:
          "If certificate is in Urdu, get it translated by a certified translator.",
        tips: [
    ...
    wizardSteps: [
      {
        ...
        description:
          "Find your original Nikah Nama document issued at the time of marriage.",
        tips: [
  ...
  },
  {
    ...
    category: "CIVIL",
    applicableVisas: UNIVERSAL_VISAS,
    ...
    wizardSteps: [
      ...
      },
      {
        ...
        description:
          "Scan or take a clear photo of the biographical page of your passport.",
        tips: [
    ...
    wizardSteps: [
      {
        ...
        description:
          "Make clear scans or photos of both front and back of your CNIC.",
        tips: [
    ...
    wizardSteps: [
      {
        ...
        description:
          "Get certified copy of divorce decree from Family Court or Union Council.",
        resources: [
          {
      ...
      },
      {
        ...
        title: "Get English Translation",
        description:
          "If document is in Urdu, get certified English translation.",
        estimatedTime: "2-3 days",
...
const FINANCIAL_DOCS: DocumentDefinition[] = [
    ...
    wizardSteps: [
      {
        ...
        description:
          "Download the latest version of Form I-864 from USCIS website.",
        resources: [
          {
    ...
    wizardSteps: [
      {
        ...
        description:
          "Contact your HR department to request an employment verification letter.",
        tips: [
  ...
  },
  {
    ...
    description: "Proof of SEVIS fee payment",
    category: "FINANCIAL",
    applicableVisas: USA_STUDENT_VISAS,
    ...
    validityType: "none",
    requiredWhen: {
      visaCategories: ["F-1 Student Visa"],
    },
  },
  {
    id: "mrv-fee-receipt",
    ...
    description: "Proof of machine-readable visa fee payment",
    category: "FINANCIAL",
    applicableVisas: USA_STUDENT_VISAS,
  ...
  {
    id: "affidavit-of-support-f1",
    key: "AFFIDAVIT_SUPPORT_F1",
    name: "Affidavit of Support",
    description: "Affidavit of support for non-immigrants",
    category: "FINANCIAL",
    applicableVisas: USA_STUDENT_VISAS,
  ...
  },
  {
    ...
    description: "Official letter confirming scholarship award",
    category: "FINANCIAL",
    applicableVisas: USA_STUDENT_VISAS,
  ...
  },
  {
    ...
    key: "LOAN_APPROVAL_LETTER",
    name: "Loan Approval Letter",
    description: "Official letter confirming education loan approval",
    category: "FINANCIAL",
    applicableVisas: USA_STUDENT_VISAS,
...
const RELATIONSHIP_DOCS: DocumentDefinition[] = [
  ...
  },
  {
    ...
    description:
      "Chat logs, call records, emails demonstrating ongoing relationship",
    category: "RELATIONSHIP",
    applicableVisas: FAMILY_VISAS,
    ...
    wizardSteps: [
      {
        ...
        description:
          "Visit your local police station or apply through NADRA for a police clearance certificate.",
        resources: [
          {
...
const MEDICAL_DOCS: DocumentDefinition[] = [
    ...
    wizardSteps: [
      {
        ...
        description:
          "Book appointment with panel physician approved by U.S. Embassy Islamabad.",
        resources: [
          {
  ...
  },
  {
    ...
    description:
      "Official International Certificate of Vaccination (issued within last 12 months)",
    category: "MEDICAL",
    applicableVisas: FAMILY_VISAS,
    ...
    wizardSteps: [
      {
        ...
        description:
          "Get a fresh dose of Oral Polio Vaccine (OPV) from any government-approved vaccination center or hospital.",
        tips: [
      ...
      },
      {
        ...
        description:
          "If vaccinated through the official system, you can also download a computerized certificate from the NADRA website.",
        resources: [
          {
  ...
  {
    id: "foreigner-physical-exam-china",
    key: "FOREIGNER_PHYSICAL_EXAM",
    name: "Foreigner Physical Examination Form",
    description: "Completed physical examination form for foreigners",
    category: "MEDICAL",
    applicableVisas: CHINA_STUDENT_VISAS,
    roles: ["BENEFICIARY"],
    stages: ["INTERVIEW"],
    required: false,
    multipleFilesAllowed: false,
...
const PHOTO_DOCS: DocumentDefinition[] = [
    ...
    wizardSteps: [
      {
        ...
        description:
          "Get 2x2 inch photos that meet U.S. visa photo requirements.",
        resources: [
          {
  ...
  {
    id: "passport-photo-china",
    key: "PASSPORT_PHOTO_CHINA",
    name: "Passport Photo (Chinese Specifications)",
    description: "Recent photo meeting Chinese visa specifications",
    category: "PHOTOS",
    applicableVisas: CHINA_STUDENT_VISAS,
    roles: ["BENEFICIARY"],
    stages: ["INTERVIEW"],
...
const TRANSLATION_DOCS: DocumentDefinition[] = [
  {
    ...
    description:
      "Certification statement from translator for all translated documents",
...
const MISC_DOCS: DocumentDefinition[] = [
  ...
  {
    id: "ds-160-confirmation",
    key: "DS160_CONFIRMATION",
    name: "DS-160 Confirmation Page",
    description: "Online Nonimmigrant Visa Application confirmation page",
    category: "MISC",
    applicableVisas: USA_STUDENT_VISAS,
  ...
  {
    id: "visa-interview-appointment",
    key: "VISA_INTERVIEW_APPT",
    name: "Visa Interview Appointment Confirmation",
    description: "Confirmation of scheduled visa interview",
    category: "MISC",
    applicableVisas: UNIVERSAL_VISAS,
  ...
  {
    id: "chinese-visa-app-form",
    key: "CHINESE_VISA_APP_FORM",
    name: "Chinese Visa Application Form (V.2013)",
    description: "Completed and signed Chinese visa application form",
    category: "MISC",
    applicableVisas: CHINA_STUDENT_VISAS,
    roles: ["BENEFICIARY"],
    stages: ["INTERVIEW"],
  ...
  {
    id: "accommodation-proof-china",
    key: "ACCOMMODATION_PROOF",
    name: "Accommodation Proof in China",
    description: "Proof of where you will stay in China",
    category: "MISC",
    applicableVisas: CHINA_STUDENT_VISAS,
    roles: ["BENEFICIARY"],
    stages: ["INTERVIEW"],
...
const EDUCATION_DOCS: DocumentDefinition[] = [
    ...
    wizardSteps: [
      {
        ...
        description:
          "Get your original Matriculation certificate from respective board.",
        tips: [
    ...
    wizardSteps: [
      {
        ...
        description:
          "Get both the degree certificate and detailed transcripts.",
        tips: [
  ...
  },
  {
    ...
    description:
      "Professional certifications and licenses (e.g., ACCA, CA, PMP)",
    category: "EDUCATION",
    applicableVisas: FAMILY_VISAS,
  ...
  {
    id: "university-admission-letter",
    key: "UNIVERSITY_ADMISSION_LETTER",
    name: "University Admission Letter",
    description: "Official acceptance letter from the U.S. university",
    category: "EDUCATION",
    applicableVisas: [...USA_STUDENT_VISAS, ...CHINA_STUDENT_VISAS],
  ...
  },
  {
    ...
    description: "Official degree certificates from previous institutions",
    category: "EDUCATION",
    applicableVisas: UNIVERSAL_VISAS,
  ...
  {
    id: "standardized-test-scores",
    key: "STANDARDIZED_TEST_SCORES",
    name: "Standardized Test Scores (GRE/GMAT/SAT)",
    description: "Official scores for GRE, GMAT, SAT, or other required tests",
    category: "EDUCATION",
    applicableVisas: USA_STUDENT_VISAS,
  ...
  },
  {
    ...
    key: "ENGLISH_PROFICIENCY_TEST",
    name: "English Proficiency Test Result (IELTS/TOEFL)",
    description: "Official scores for IELTS, TOEFL, Duolingo, etc.",
    category: "EDUCATION",
    applicableVisas: ALL_STUDENT_VISAS,
  ...
  },
  {
    ...
    description: "Official CoE issued by the Australian education provider",
    category: "EDUCATION",
    applicableVisas: AUSTRALIA_STUDENT_VISAS,
    roles: ["BENEFICIARY"],
    stages: ["INTERVIEW"],
    required: true,
    multipleFilesAllowed: false,
  ...
  {
    id: "gs-statement-australia",
    key: "GS_STATEMENT",
    name: "Genuine Student (GS) Statement",
    description: "Statement explaining your intentions for study in Australia",
    category: "EDUCATION",
    applicableVisas: AUSTRALIA_STUDENT_VISAS,
    roles: ["BENEFICIARY"],
    stages: ["INTERVIEW"],
...
const TRAVEL_DOCS: DocumentDefinition[] = [
  ...
  },
  {
    ...
    description: "Flight booking/itinerary for travel to China",
    category: "TRAVEL",
    applicableVisas: CHINA_STUDENT_VISAS,
    roles: ["BENEFICIARY"],
    stages: ["INTERVIEW"],
    ...
    wizardSteps: [
      {
        ...
        description:
          "Get your domicile certificate from the district administration.",
        resources: [
          {
...
const IMMIGRATION_DOCS: DocumentDefinition[] = [
  ...
  },
  {
    ...
    name: "Form I-20",
    description:
      "Certificate of Eligibility for Nonimmigrant Student Status (Signed by DSO and Student)",
    category: "IMMIGRATION",
    applicableVisas: USA_STUDENT_VISAS,
  ...
  {
    id: "jw201-jw202-form",
    key: "JW201_JW202_FORM",
    name: "JW201 or JW202 Form",
    description: "Visa Application for Study in China form",
    category: "IMMIGRATION",
    applicableVisas: CHINA_STUDENT_VISAS,
    roles: ["BENEFICIARY"],
    stages: ["INTERVIEW"],
    ...
    wizardSteps: [
      {
        ...
        tips: ["Last 3 years recommended", "NTN certificate also helpful"],
      },
    ],
  },
  {
    ...
    wizardSteps: [
      {
        ...
        description:
          "Request affidavits from friends/family who can attest to your marriage.",
        tips: [
...
const HEALTH_INSURANCE_DOCS: DocumentDefinition[] = [
  ...
  },
  {
    ...
    description:
      "Proof of health insurance for the entire duration of stay in Australia",
    category: "HEALTH_INSURANCE",
    applicableVisas: AUSTRALIA_STUDENT_VISAS,
    roles: ["BENEFICIARY"],
    stages: ["INTERVIEW"],
...
const OTHER_DOCS: DocumentDefinition[] = [
  ...
  {
    id: "proof-home-country-ties",
    key: "PROOF_HOME_COUNTRY_TIES",
    name: "Proof of Home Country Ties",
    description:
      "Evidence of intent to return to home country (property, family, job offers)",
    category: "OTHER",
    applicableVisas: USA_STUDENT_VISAS,
  ...
  {
    id: "visa-app-form-australia",
    key: "VISA_APP_FORM_AUSTRALIA",
    name: "Visa Application Form (ImmiAccount Submission)",
    description: "Copy of the submitted online visa application form",
    category: "OTHER",
    applicableVisas: AUSTRALIA_STUDENT_VISAS,
    roles: ["BENEFICIARY"],
    stages: ["INTERVIEW"],
  ...
  },
  {
    ...
    description: "Detailed study plan or statement of purpose",
    category: "OTHER",
    applicableVisas: [...AUSTRALIA_STUDENT_VISAS, ...CHINA_STUDENT_VISAS],
    roles: ["BENEFICIARY"],
    stages: ["INTERVIEW"],
    required: false,
    multipleFilesAllowed: false,
  ...
  {
    id: "temp-residence-reg-china",
    key: "TEMP_RESIDENCE_REG_CHINA",
    name: "Temporary Residence Registration",
    description: "Proof of registration after arrival in China",
    category: "OTHER",
    applicableVisas: CHINA_STUDENT_VISAS,
    roles: ["BENEFICIARY"],
    stages: ["INTERVIEW"],
  ...
  {
    id: "residence-permit-study-china",
    key: "RESIDENCE_PERMIT_STUDY_CHINA",
    name: "Residence Permit for Study",
    description: "Study residence permit (required after entry for X1)",
    category: "OTHER",
    applicableVisas: CHINA_STUDENT_VISAS,
    roles: ["BENEFICIARY"],
    stages: ["INTERVIEW"],
