        ...
        <>
          ...
          >
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                <div className="w-11 h-11 rounded-xl bg-teal-50 flex items-center justify-center">
                  <FileText className="w-5.5 h-5.5 text-teal-700" />
                </div>
            ...
            <h3 className="text-base font-bold text-slate-900 mb-2 font-['Plus_Jakarta_Sans','Inter',system-ui,sans-serif]">
              What is a Marriage Certificate (MRC)?
            </h3>

            <p className="text-[0.875rem] leading-[1.7] text-slate-600 mb-6">
              {data.description}
            </p>
            ...
            >
              ...
              <div>
                <p className="text-[0.8rem] font-bold text-amber-800 mb-1">
                  Important Disclaimer
                </p>

                <p className="text-[0.8rem] leading-[1.6] text-amber-900/80">
                  {data.disclaimer}
                </p>
              </div>
            </div>
