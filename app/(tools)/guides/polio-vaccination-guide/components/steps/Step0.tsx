...
import { ShieldCheck, Globe, Clock, IdCard } from "lucide-react";
    ...
    <div className="max-w-4xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="mb-8 text-center md:text-left">
        ...
        <p className="text-slate-600 text-lg leading-relaxed max-w-2xl">
          A Polio Vaccination Certificate is an official document proving you
          have received the polio vaccine. It is managed by NADRA through the
        ...
        {[
          {
            ...
            desc: "Required by many countries (e.g., Egypt, Saudi Arabia) to reduce the international spread of the virus.",
          },
          {
            icon: Clock,
            title: "Validity",
            desc: "The certificate is generally considered valid for approximately 1 year for travel.",
          },
        ].map((item, i) => (
          <div
            key={i}
      ...
      <div className="bg-primary/5 rounded-2xl p-6 border border-primary/10 relative overflow-hidden group">
        ...
        <div className="relative z-10">
          ...
          <ul className="grid grid-cols-1 sm:grid-cols-2 gap-y-3 gap-x-6 text-slate-800 font-medium text-sm">
            <li className="flex items-center gap-2">
              <div className="w-1.5 h-1.5 rounded-full bg-primary"></div>{" "}
              International travel from Pakistan
            </li>
            <li className="flex items-center gap-2">
              <div className="w-1.5 h-1.5 rounded-full bg-primary"></div>{" "}
            ...
            <li className="flex items-center gap-2">
              <div className="w-1.5 h-1.5 rounded-full bg-primary"></div> Birth
              / Marriage Certificates (e.g. in KP)
            </li>
          </ul>
        </div>
      </div>
