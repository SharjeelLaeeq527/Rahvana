...
// Assuming offices.json is available at this path
...
export default function OfficeFinderStep({
  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 p-4 sm:p-6 lg:p-8">
      <div className="mb-0 sm:mb-8 flex items-start justify-between gap-4">
        <div>
          <h2 className="text-3xl font-bold text-slate-900 mb-3 tracking-tight flex items-center gap-3">
            ...
            <span>Nearest NADRA Offices</span>
          </h2>
      ...
      <div className="bg-amber-50 border border-amber-100 rounded-xl p-4 flex gap-3 items-start mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-amber-800/80 leading-relaxed">
            Ensure that the NADRA office you plan to visit offers the services
            you needed. Office listings and contact information may change;
            always confirm details before visiting or verify via the official
            helpline.
          </p>
        </div>
      </div>
        ...
        {displayOffices.length > 0 ? (
          displayOffices.map((office: Office, i: number) => (
            ...
            >
              ...
              {office.notes && (
                <div className="px-4 py-2.5 rounded-xl bg-primary/10 text-sm text-primary border border-primary flex items-start gap-2">
