...
import { X, Info, FileText, CheckCircle2 } from "lucide-react";
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-2xl font-bold text-slate-900">
                  CNIC Guide Application Wizard
                </h2>
                <p className="text-sm text-slate-500 mt-0.5">
                  Computerised National Identity Card by NADRA
                </p>
              </div>
            </div>
            <button
          ...
          <div className="space-y-6">
            <section>
              ...
              <p className="text-slate-600 leading-relaxed text-sm">
                The CNIC is your most important identity document in Pakistan.
                Whether you are applying for the first time, needing a
                replacement, or correcting your details, this interactive wizard
                will customize the required document list, application process
                (online vs in-person), and expected timelines based on your
              ...
              <ul className="space-y-3 text-sm text-slate-600">
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    ...
                    See exactly what you need based on your situation instead of
                    a generic list.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    ...
                    Find out the common mistakes that get CNIC applications
                    rejected.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    <strong className="text-slate-800">Clear Steps:</strong> A
                    tailored roadmap depending on whether you choose to use the
                    Pak ID app or visit a NADRA center.
                  </span>
                </li>
              </ul>
            </section>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm text-amber-800">
                  ...
                  <p>
                    ...
                    website. NADRA policies frequently change, so always verify
                    from NADRA&apos;s official helpline (1777) or website before
                    visiting a center.
                  </p>
                </div>
              </div>
