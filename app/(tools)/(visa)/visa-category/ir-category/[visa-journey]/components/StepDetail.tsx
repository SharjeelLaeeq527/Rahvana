...
import { Info, Users, MapPin, ArrowLeft, ArrowRight, CheckCircle2, Circle, ClipboardList, Wand2 } from "lucide-react";
    ...
    >
      <div className="mb-8">
        <div className="inline-flex items-center gap-2 px-3 py-1 bg-slate-100/80 text-slate-500 rounded-full text-[12px] font-bold uppercase tracking-wider mb-4 border border-slate-200/50">
          ...
          {t("visaJourney.stageStep", { stage: stage.id.toString(), step: step.id.toString() })}
        </div>
