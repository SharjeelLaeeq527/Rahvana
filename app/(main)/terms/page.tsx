          ...
          <main className="flex-1 min-w-0 max-w-3xl">
            <div className="prose prose-gray max-w-none
              ...
              <div className="not-prose bg-amber-50 border border-amber-200 rounded-xl px-4 py-3 flex items-start gap-2 mb-10">
                ...
                <p className="text-sm text-amber-700"><strong>Disclaimer:</strong> Rahvana is not a law firm and does not provide legal advice. Consult a licensed immigration attorney for legal guidance.</p>
              </div>

              <Section id="acceptance" title="1. Acceptance">
                <p>By accessing or using Rahvana at <a href="https://rahvana.com">rahvana.com</a>, you agree to these Terms of Service. If you do not agree, please do not use our platform.</p>
              </Section>
              ...
              <Section id="rules" title="4. Your Responsibilities">
                <p>Use Rahvana only for personal, lawful immigration purposes. Do not share your account, attempt to reverse-engineer the platform, or use it to offer paid immigration services to others.</p>
              </Section>
