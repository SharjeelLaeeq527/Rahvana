          ...
          <main className="flex-1 min-w-0 max-w-3xl">
            <div className="prose prose-gray max-w-none
              ...
              <Section id="what" title="1. What Are Cookies?">
                <p>Cookies are small files stored in your browser that help websites remember you and work properly.</p>
              </Section>

              <Section id="types" title="2. Cookies We Use">
                <ul>
                  <li><strong>Essential:</strong> Keep you logged in and secure. Cannot be disabled.</li>
                  <li><strong>Payment (Stripe):</strong> Fraud prevention during checkout. Required for payments.</li>
                  <li><strong>Functional:</strong> Remember your preferences and save your progress.</li>
                  <li><strong>Analytics:</strong> Understand how visitors use Rahvana (anonymous data).</li>
                </ul>
              </Section>

              <Section id="managing" title="3. Managing Cookies">
                <p>You can control or disable cookies through your browser settings. Disabling essential cookies may prevent login and core features from working. To opt out of Google Analytics, visit <a href="https://tools.google.com/dlpage/gaoptout" target="_blank" rel="noopener noreferrer">tools.google.com/dlpage/gaoptout</a>.</p>
              </Section>

              <Section id="consent" title="4. Your Consent">
                <p>By using Rahvana, you consent to our use of essential and payment cookies. You may opt out of analytics cookies at any time via your browser settings.</p>
              </Section>
